...
test("getPayloadHash", async (t) => {
	...
	await t.test(
		"should return the hex-encoded hash of a string body",
		async (t) => {
			const hash = getPayloadHash({
				...t.context.requestData,
				body: "foo",
	...
	await t.test(
		"should return the hex-encoded hash of a ArrayBufferView body",
		async (t) => {
			const hash = getPayloadHash({
				...t.context.requestData,
	...
	await t.test(
		"should return the hex-encoded hash of a ArrayBuffer body",
		async (t) => {
			const hash = getPayloadHash({
				...t.context.requestData,
